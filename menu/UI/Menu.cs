...
namespace menu.UI
{
    class Menu
    {
        ...
        public void LoadContent(ContentManager Content)
        {
            ...
            WMP.URL = @"C:\Users\User\source\repos\menu\menu\Content\selectsound.mp3";
            enterWMP.URL = @"C:\Users\User\source\repos\menu\menu\Content\entersound.mp3";
                ...
                if (keyboard.IsKeyDown(Keys.Enter))
                {
                    ...
                    switch (selected)
                    {
                        ...
                        case 1:
                            ...
                            break;
                        case 2:
                            Game1.gameState = GameState.WindowFrame;
                            break;
                        case 3:
                            Game1.gameState = GameState.Settings;
                            selected = 0;
                ...
                switch (selected)
                {
                    ...
                    case 1:
                        if (keyboard.IsKeyDown(Keys.Left) && ssize > 0)
                        {
                            ...
                            WMP.settings.volume = ssize * 10;
                            enterWMP.settings.volume = ssize * 10;
                        }
